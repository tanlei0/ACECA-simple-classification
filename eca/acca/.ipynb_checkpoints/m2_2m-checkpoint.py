...
if __name__ == "__main__":
    ...
    plot_space(title='m2+2m', datas=aceca.sim_datas, gaps=[12], save_=False)

    # 绘制密度
    # plot_dense(datas=aceca.sim_datas, title='m2+2m', save_path="./result/m2+2m_density.jpg")
